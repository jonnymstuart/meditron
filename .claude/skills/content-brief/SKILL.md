---
name: content-brief
description: Turn a keyword cluster from data/keywords into a 4‑language content brief (EN master + DE/FR/IT localisation notes) with SERP intent, outline, entities, FAQs, schema and internal links. Output to content/_briefs/<slug>.md.
---
# Content brief
...
4. Set front-matter `status: brief-ready` and list it in `content/_briefs/README.md` (the content calendar). Don't draft the page yet — the client approves briefs first (48 h silent approval).
